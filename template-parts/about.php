<?php
$about_heading = get_field('about_heading') ? get_field('about_heading') : 'Ubezpieczenia majątkowe';
$about_subheading = get_field('about_subheading') ? get_field('about_subheading') : 'Co obejmują?';
$about_content = get_field('about_content') ? get_field('about_content') : '<p>
<strong>
